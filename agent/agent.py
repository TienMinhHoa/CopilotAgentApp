...
from image_process_node import process_image_node
def route(state: AgentState):
    ...
    if messages and isinstance(messages[-1], AIMessage):
        ...
        if ai_message.tool_calls:
            ...
            if tool_name in ["add_products", "delete_products", "process_image"]:
...
workflow.add_conditional_edges("chat_node", route, ["add_product", "chat_node", "delete_product", "process_image", END])
...
workflow.add_edge("process_image", "chat_node")
